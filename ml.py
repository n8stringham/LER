...
def vectorize_data(train_data, test_data):
    ...
    filename = 'DictVectorizer_all.joblib'
...
if __name__ == '__main__':
    ...
    assert features_set.issubset({'WORD', 'POS', 'WORD-2', 'WORD-1','WORD+1', 'WORD+2', 'POS-2', 'POS-1','POS+1','POS+2', 'LABEL'}), 'There is an invalid feature name'
    ...
    classes = ['B-PER', 'I-PER', 'B-FAC', 'I-FAC', 'B-GPE', 'I-GPE', 'B-LOC', 'I-LOC', 'B-VEH', 'I-VEH', 'B-ORG', 'I-ORG', 'O']
